...
describe("PriorityQueue", () => {
  describe("Basic Functionality (Max-Heap behavior)", () => {
    ...
    it("peek should return the highest priority item without removing it", () => {
      pq.push(10, 30, 20);
      expect(pq.peek()).toBe(30);
      expect(pq.size()).toBe(3);
    });

    it("pop should return items in descending order (Max-Heap)", () => {
  ...
  describe("Min-Heap behavior", () => {
    it("should return items in ascending order with a min-heap comparator", () => {
  ...
  describe("Object-based Priority", () => {
    ...
    it("should handle objects based on a property", () => {
  ...
  describe("Edge Cases", () => {
    it("should return undefined when peeking/popping an empty queue", () => {
      const pq = new PriorityQueue<number>((a, b) => a > b);
      expect(pq.peek()).toBeUndefined();
      expect(pq.pop()).toBeUndefined();
    });

    it("should handle large batches of interleaved push and pop", () => {
      const pq = new PriorityQueue<number>((a, b) => a > b);
