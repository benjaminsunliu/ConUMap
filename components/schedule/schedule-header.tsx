    ...
    >
          ...
          >
            <Text
              style={[
                ...
                { color: theme.scheduleHeader.monthButtonText },
              ]}
            >
              {MONTHS[month]} {year}
            </Text>
          ...
          >
            <Text
              style={[
                ...
                { color: theme.scheduleHeader.todayButtonText },
              ]}
            >
              Today
            </Text>
      ...
      >
        <View
          style={[
            styles.backdrop,
            { backgroundColor: theme.scheduleHeader.monthPickerBackdrop },
          ]}
        >
          <Pressable
            ...
            {MONTHS.map((name, index) => (
              <Pressable
                ...
                style={[
                  ...
                  index === month && {
                    backgroundColor: theme.scheduleHeader.monthMenuItemActive,
                  },
                ]}
              >
                <Text
