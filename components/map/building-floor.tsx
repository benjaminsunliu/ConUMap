  ...
  return (
    <G key={`node-${floorCheckpoint.id}`}>
      ...
      {renderIconLayer({
        ...
        highlightX: floorCheckpoint.x - 32,
        highlightY: floorCheckpoint.y - 32,
        highlightWidth: 64,
        highlightHeight: 64,
        highlightRx: 10,
      ...
      {renderIconLayer({
        ...
        highlightX: floorCheckpoint.x - 28,
        highlightY: floorCheckpoint.y - 60,
        highlightWidth: 80,
        highlightHeight: 80,
        highlightRx: 12,
      ...
      {renderIconLayer({
        ...
        highlightY: floorCheckpoint.y - 64,
        highlightWidth: 90,
        highlightHeight: 90,
        highlightRx: 12,
