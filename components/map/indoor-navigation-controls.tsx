...
export default function IndoorNavigationControls({ instruction, onNext, onPrevious, canGoNext = true, canGoPrevious = true }: IndoorNavigationControlsProps) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.centerCard}>
                ...
                <Ionicons name="arrow-up" size={20} color={theme.mapSettings.icon} style={{ marginTop: 4 }} />
            </View>

            <TouchableOpacity style={[styles.sideButton, !canGoNext && styles.disabled]} onPress={onNext} disabled={!canGoNext}>
