...
function injectManualData(info: APIResponse["results"][number]) {
  const manualOverrides: {
    ...
    MU: {
      ...
      // outline to preserve the west-to-east Bishop Annex sequence.
      polygon: [
        [-73.5796129843803, 45.498005813165],
        [-73.579779728197, 45.497827663139],
        [-73.5797039317568, 45.4977905107449],
        [-73.5795371416831, 45.4979631908601],
        [-73.5796129843803, 45.498005813165],
      ],
      location: {
        lat: 45.4978851223049,
        lng: -73.5796629426972,
      },
    },
    PC: {
      polygon: [
